...
function loadStatsPage() {
	var wins = 0;
	var losses = 0;
	for (var x = 2; x < document.getElementById('stats_table').rows.length; x++)
	{
		if (document.getElementById('stats_table').rows[x].cells[2].innerHTML > document.getElementById('stats_table').rows[x].cells[3].innerHTML)
		{
			wins++;
			document.getElementById('stats_table').rows[x].cells[4].innerHTML = "CU";
		}
		else
		{
			losses++;
			var z = document.getElementById('stats_table').rows[x].cells;
			z[4].innerHTML = document.getElementById('stats_table').rows[x].cells[1].innerHTML;
		}
	}
...
function loadPlayersPage()
{
	...
	for (var i = 0; i < players.length; i++)
	{
		...
		option.setAttribute("onclick",'switchPlayers('+i+')');
